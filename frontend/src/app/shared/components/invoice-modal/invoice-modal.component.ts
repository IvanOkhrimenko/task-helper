          ...
          <div class="modal__body">
            ...
            <div class="info-bar">
              ...
              <div class="info-item">
                ...
                <span class="info-value">{{ task()?.client?.name || 'Not specified' }}</span>
              </div>
            </div>
            ...
            <section class="form-section">
              <h3 class="section-title">
                ...
                {{ useFixedAmount ? 'Fixed Amount' : 'Hours & Rate' }}
              </h3>
              ...
              @if (useFixedAmount) {
                ...
                <div class="total-preview">
                  <div class="total-calc">
                    <span class="total-formula">{{ hoursWorked || 0 }} hrs × {{ currentCurrencySymbol() }}{{ hourlyRate || 0 }}</span>
              ...
              <section class="form-section">
                ...
                <div class="form-row">
                  ...
                  @if (googleAccounts().length > 0) {
                    <div class="form-group">
                      <label class="form-label">Send via Gmail</label>
                      ...
                      <span class="form-hint">Create draft in Gmail</span>
                    </div>
                  }
                </div>
              </section>
                ...
                <div class="section-content">
                  ...
                  <div class="toggle-row">
                    <label class="toggle-label">
                      <span>Use Custom Email Template</span>
                      <span class="toggle-hint">Override default email with your own content</span>
                    </label>
                    ...
                    <div class="email-preview" [class.email-preview--custom]="useCustomEmailTemplate">
                      <div class="email-preview__header">
                        @if (useCustomEmailTemplate) {
                          ...
                          <span>Custom email template</span>
                        } @else {
                          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <circle cx="12" cy="12" r="10"/>
                            <path d="M12 16v-4"/>
