    ...
    <div class="activity-timeline" [class.activity-timeline--empty]="activities().length === 0">
      @if (activities().length === 0) {
        <div class="empty-state">
          ...
          <p class="empty-state__subtext">All changes will appear here</p>
        </div>
      } @else {
        <div class="timeline">
              ...
              <div class="timeline-item__content">
                <div class="timeline-item__header">
                  <div class="timeline-item__action">
                    ...
                    <span class="timeline-item__label">{{ getActionConfig(activity.action).label }}</span>
                  </div>
                ...
                @if (activity.changes && Object.keys(activity.changes).length > 0) {
                  ...
                  >
                    ...
                    <span>{{ expandedItems()[activity.id] ? 'Hide' : 'Show' }} changes ({{ Object.keys(activity.changes).length }})</span>
                  </button>
                  ...
                  <div class="timeline-item__metadata">
                    ...
                    @if (activity.metadata['crmInvoiceId']) {
                      <span class="metadata-tag metadata-tag--crm">
                        ...
                        CRM: {{ activity.metadata['crmInvoiceId'] }}
                      </span>
                    }
