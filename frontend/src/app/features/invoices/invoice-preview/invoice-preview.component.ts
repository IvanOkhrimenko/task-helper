                ...
                <div class="card card--email">
                  ...
                  <div class="email-draft">
                    ...
                    <div class="email-actions">
                      ...
                      @if (invoice()?.task?.googleAccountId) {
                        <button
                          class="btn btn--gmail"
...
export class InvoicePreviewComponent implements OnInit, OnDestroy {
  ...
  createGmailDraft() {
    ...
    if (!inv?.task?.googleAccountId || !draft) {
      this.notificationService.error('Unable to create draft: missing configuration');
      return;
    }
    ...
    this.googleService.createDraft({
      googleAccountId: inv.task.googleAccountId,
